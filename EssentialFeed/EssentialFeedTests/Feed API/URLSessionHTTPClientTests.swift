...
//  EssentialFeedTests
//
//  Created by Kholmumin Tursinboev on 1/8/25.
//
...
final class URLSessionHTTPClientTests: XCTestCase{
    ...
    func test_getFromURL_succeedsOnHTTPURLResponseWithData(){
        ...
        let receivedValues = resultValuesForData(data: data, response: response, error: nil)
    ...
    func test_getFromURL_succeedsWithEmptyDataOnHTTPURLResponseWithNilData(){
        let response = anyHTTPURLResponse()
        let receivedValues = resultValuesForData(data: nil, response: response, error: nil)
    ...
    private func resultValuesForData(
        data: Data?,
